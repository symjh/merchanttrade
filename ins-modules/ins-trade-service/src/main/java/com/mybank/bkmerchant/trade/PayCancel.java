...
public class PayCancel {
	...
	public static void main(String[] args) throws Exception {
		Map<String, Object> map = PayQuery.payQuery(HttpsMain.merchantId, "eb55f3ba-8973-485d-a86d-387e9e75bb54");
		//非处理中订单不能关闭
		if (MapUtils.isEmpty(map) || !StringUtils.equals(TradeStatusEnum.paying.getStatusCode(), map.get("TradeStatus").toString())) {
			System.out.println(map.get("TradeStatus").toString() + "订单状态不是支付中无法撤单");
			return;
		}
		payCancel(HttpsMain.merchantId, "3db6ec42abd142b98377a681b944b8bf");
	...
	public static boolean payCancel(String merchantId, String outTradeNo) throws Exception {
		...
		@SuppressWarnings("rawtypes") String resultCode = (String) ((Map) resMap.get("RespInfo")).get("ResultCode");
		if (StringUtils.equals(ReturnCodeEnum.SUCCESS.getReturnCode(), resultCode) || StringUtils.equals(ReturnCodeEnum.ORDER_CLOSED.getReturnCode(), resultCode)) {
			return true;
		}
		return false;
	}
