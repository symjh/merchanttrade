...
public class SignatureUtils {
	 ...
	 */
	public static PrivateKey getPrivateKey(String encodePrivateKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
	 ...
	 * @throws InvalidKeySpecException
	 */
	public static PublicKey getPublicKey(String encodePublicKey) throws NoSuchAlgorithmException, InvalidKeySpecException {
	 ...
	 */
	public static String signXmlElement(PrivateKey privateKey, Document xmlDocument, String elementTagName, String algorithm, int signatureAppendMode) throws Exception {
	 ...
	 * @throws Exception the exception
	 */
	public static boolean verifyXmlElement(PublicKey publicKey, Document xmlDocument) throws Exception {
