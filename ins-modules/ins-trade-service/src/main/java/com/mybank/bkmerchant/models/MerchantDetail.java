...
public class MerchantDetail {
  ...
  /**
   * 他行卡储蓄卡卡号，用于核验客户身份，并作为网商银行账户绑定的银行卡，余利宝及银行卡账户的资金仅能提现到该银行卡中。利用换卡接口可更换绑定银行卡
   */
  ...
  public MerchantDetail(String alias, String contactMobile, String contactName, String province, String city, String district, String address,
                        ...
                        String principalCertNo, String principalPerson, String otherBankCardNo, String bussAuthNum, String certOrgCode, String
                                certPhotoA, String certPhotoB, String licensePhoto, String prgPhoto, String industryLicensePhoto, String shopPhoto,
                        String otherPhoto, String subscribeAppId) {
    this.alias = alias;
    ...
    this.otherBankCardNo = otherBankCardNo;
  ...
  public String getOtherBankCardNo() {
    return otherBankCardNo;
  }

  public void setOtherBankCardNo(String otherBankCardNo) {
    this.otherBankCardNo = otherBankCardNo;
  }
  ...
  public String genJsonBase64() throws JSONException {
    ...
    obj.put("OtherBankCardNo", otherBankCardNo);
