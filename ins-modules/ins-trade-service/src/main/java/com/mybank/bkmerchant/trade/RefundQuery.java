...
public class RefundQuery {
	...
	public static void main(String[] args) throws Exception {
		refundQuery(HttpsMain.merchantId, "3bc5fb7f-8a40-4e07-abe5-dc24fbad60dd");

	}

	public static Map<String, Object> refundQuery(String merchantId, String outRefundNo) throws Exception {
		//账户余额查询
	...
	public static TradeStatusEnum refundStatusQuery(String merchantId, String outRefundNo) throws Exception {
